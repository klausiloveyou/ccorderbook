...
$designer = "Patricia Vogt";
$stylename = "Dreamwalker";
?>
...
<div class="container">
    <nav class="navbar navbar-expand navbar-light bg-faded">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item active" href="../toh/dreamwalker1.php">Dreamwalker</a>
        ...
        <a class="navbar-right btn btn-default" href="../toh/dreamwalker1.php" aria-label="Prev">
...
<div class="container sheet">
    <div class="row">
        <div class="col-md-2 text-left">
            <img height="200" src="../../img/the_overlook_hotel/dreamwalker.jpg">
        </div>
            ...
            <form action="javascript:void(0);" method="post">
                ...
                <table class="table table-bordered no-border-left no-border-right no-border-top">
                    <tr>
                        ...
                        <td colspan="5" class="text-center"><img src="../../img/the_overlook_hotel/dreamwalker_4.jpg" height="150" alt="Piece 4"/></td>
                        <td colspan="5" class="text-center"><img src="../../img/the_overlook_hotel/dreamwalker_5.jpg" height="150" alt="Piece 5"/></td>
