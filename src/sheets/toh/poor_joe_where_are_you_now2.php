...
$designer = "Nastassia Volkus";
$stylename = "Poor Joe where are you now";
?>
...
<div class="container">
    <nav class="navbar navbar-expand navbar-light bg-faded">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item active" href="../toh/poor_joe_where_are_you_now1.php">Poor Joe where are you now</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <a class="navbar-right btn btn-default" href="../toh/poor_joe_where_are_you_now1.php" aria-label="Prev">
...
<div class="container sheet">
    <div class="row">
        <div class="col-md-2 text-left">
            <img height="200" src="../../img/the_overlook_hotel/poor_joe_where_are_you_now.jpg">
        </div>
            ...
            <form action="javascript:void(0);" method="post">
                ...
                <table class="table table-bordered no-border-left no-border-right no-border-top">
                    <tr>
                        ...
                        <td colspan="5" class="text-center"><img src="../../img/the_overlook_hotel/poor_joe_where_are_you_now_4.jpg" height="150" alt="Piece 4"/></td>
                    ...
                    <tr>
                        ...
                        <td class="no-border-right no-border-right no-border-bottom no-border-left no-border-top"></td>
                        <td class="no-border-right no-border-right no-border-bottom no-border-left no-border-top"></td>
                        <td class="text-right sum-5 no-border-right no-border-bottom no-border-left no-border-top"></td>
                        <td class="no-border-right no-border-right no-border-bottom no-border-left no-border-top"></td>
                        <td class="no-border-right no-border-right no-border-bottom no-border-left no-border-top"></td>
                        <td class="no-border-right no-border-right no-border-bottom no-border-left no-border-top"></td>
                        <td class="no-border-right no-border-right no-border-bottom no-border-left no-border-top"></td>
