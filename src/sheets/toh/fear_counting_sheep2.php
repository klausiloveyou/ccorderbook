 ...
 * User: klausiloveyou
 */
$designerteam = "The Overlook Hotel";
$designer = "Carla Ren&eacute;e Loose";
$stylename = "Fear Counting Sheep";
?>
...
<div class="container">
    <nav class="navbar navbar-expand navbar-light bg-faded">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item active" href="../toh/fear_counting_sheep1.php">Fear Counting Sheep</a>
        ...
        <a class="navbar-right btn btn-default" href="../toh/fear_counting_sheep1.php" aria-label="Prev">
...
<div class="container sheet">
    <div class="row">
        <div class="col-md-2 text-left">
            <img height="200" src="../../img/the_overlook_hotel/fear_counting_sheep.jpg">
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="javascript:void(0);" method="post">
                ...
                <table class="table table-bordered no-border-left no-border-right no-border-top">
                    <tr>
                        <td class="vertical-text"></td>
                        <td colspan="5" class="text-center"><img src="../../img/the_overlook_hotel/fear_counting_sheep_4.jpg" height="150" alt="Piece 4"/></td>
                        <td colspan="5" class="text-center"><img src="../../img/the_overlook_hotel/fear_counting_sheep_5.jpg" height="150" alt="Piece 5"/></td>
                        <td colspan="5" class="text-center no-border-right no-border-bottom no-border-left no-border-top"></td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-right">Quantity</td>
                        <td class="no-border-right"></td>
                        <td class="no-border-right no-border-right no-border-bottom no-border-left no-border-top"></td>
                        <td class="no-border-right no-border-right no-border-bottom no-border-left no-border-top"></td>
                        <td class="no-border-right no-border-right no-border-bottom no-border-left no-border-top"></td>
                        <td class="no-border-right no-border-right no-border-bottom no-border-left no-border-top"></td>
                        <td class="no-border-right no-border-right no-border-bottom no-border-left no-border-top"></td>
                    ...
                    <tr>
                        ...
                        <td class="no-border-right no-border-right no-border-bottom no-border-left no-border-top"></td>
                        <td class="no-border-right no-border-right no-border-bottom no-border-left no-border-top"></td>
                        <td class="text-right sum-6 no-border-right no-border-bottom no-border-left no-border-top"></td>
                        <td class="no-border-right no-border-right no-border-bottom no-border-left no-border-top"></td>
                    </tr>
                    <tr>
