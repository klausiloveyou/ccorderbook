...
<div class="container">
    <nav class="navbar navbar-expand navbar-light bg-faded">
        ...
        <a class="navbar-right btn btn-default" href="../ssst/sleepy_oop2.php" aria-label="Next">
...
<div class="container sheet">
    <div class="row">
        <div class="col-md-2 text-left">
            <img height="200" src="../../img/stacked_skin_smooth_touch/sleepy_oop.jpg">
        </div>
            ...
            <form action="javascript:void(0);" method="post">
                ...
                <table class="table table-bordered no-border-left no-border-right">
                    <tr>
                        ...
                        <td colspan="5" class="text-center"><img src="../../img/stacked_skin_smooth_touch/sleepy_oop_1.jpg" height="150" alt="Piece 1"/></td>
                        <td colspan="5" class="text-center"><img src="../../img/stacked_skin_smooth_touch/sleepy_oop_2.jpg" height="150" alt="Piece 2"/></td>
                        <td colspan="5" class="text-center"><img src="../../img/stacked_skin_smooth_touch/sleepy_oop_3.jpg" height="150" alt="Piece 3"/></td>
                    </tr>
                    <tr>
