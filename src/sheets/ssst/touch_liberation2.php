 ...
 * User: klausiloveyou
 */
$designerteam = "Stacked Skin, Smooth Touch";
$designer = "Atefeh Farzandi";
$stylename = "Touch Liberation";
?>
...
<div class="container">
    <nav class="navbar navbar-expand navbar-light bg-faded">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item" href="../ub/untieded1.php">Untieded</a>
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item active" href="../ssst/touch_liberation1.php">Touch Liberation</a>
        ...
        <a class="navbar-right btn btn-default" href="../ssst/touch_liberation1.php" aria-label="Prev">
...
<div class="container sheet">
    <div class="row">
        <div class="col-md-2 text-left">
            <img height="200" src="../../img/stacked_skin_smooth_touch/touch_liberation2.jpg">
        </div>
            ...
            <form action="javascript:void(0);" method="post">
                ...
                <table class="table table-bordered no-border-left no-border-right">
                    <tr>
                        ...
                        <td colspan="5" class="text-center"><img src="../../img/stacked_skin_smooth_touch/touch_liberation_4.jpg" height="150" alt="Piece 4"/></td>
                        <td colspan="5" class="text-center"><img src="../../img/stacked_skin_smooth_touch/touch_liberation_5.jpg" height="150" alt="Piece 5"/></td>
                        <td colspan="5" class="text-center"><img src="../../img/stacked_skin_smooth_touch/touch_liberation_6.jpg" height="150" alt="Piece 6"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-right"><input type="number" disabled name="46_4" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                        <td class="no-border-top no-border-bottom no-border-right"></td>
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="46_5" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                        <td class="no-border-top no-border-bottom no-border-right"></td>
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="46_6" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                    </tr>
                    <tr>
                        ...
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="48_4" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                        <td class="no-border-top no-border-bottom no-border-right"></td>
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="48_5" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                        <td class="no-border-top no-border-bottom no-border-right"></td>
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="48_6" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                    </tr>
                    <tr>
                        ...
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="50_4" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                        <td class="no-border-top no-border-bottom no-border-right"></td>
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="50_5" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                        <td class="no-border-top no-border-bottom no-border-right"></td>
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="50_6" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                    </tr>
                    <tr>
                        ...
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="52_4" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                        <td class="no-border-top no-border-bottom no-border-right"></td>
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="52_5" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                        <td class="no-border-top no-border-bottom no-border-right"></td>
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="52_6" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                    </tr>
                    <tr>
                        ...
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="54_4" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                        <td class="no-border-top no-border-bottom no-border-right"></td>
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="54_5" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                        <td class="no-border-top no-border-bottom no-border-right"></td>
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="54_6" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                    </tr>
                    <tr>
                        ...
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="56_4" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                        <td class="no-border-top no-border-bottom no-border-right"></td>
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="56_5" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                        <td class="no-border-top no-border-bottom no-border-right"></td>
                        <td class="no-border-top no-border-bottom no-border-right no-border-left"></td>
                        <td class="no-border-top no-border-bottom no-border-left"></td>
                        <td class="text-right"><input type="number" disabled name="56_6" min="0" max="999" value="0"/></td>
                        <td><input type="checkbox" value=""/></td>
                    </tr>
                    <tr>
...
<script type="text/javascript">
    $("form").submit(function() {
        ...
        $.post("../../order2.php", str, function(result) {
    ...
    $("input[type='checkbox']").change(function() {
        if ($(this).prop("checked")) {
            ...
            calculateSum($(this).parent().prev().find("input"));
