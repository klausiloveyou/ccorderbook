            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item active" href="../ssst/sleepy_oop1.php">Sleepy Oop</a>
                        <a class="dropdown-item" href="../ssst/smooth_operator1.php">Smooth Operator</a>
                    </div>
                </li>
            </ul>
        </div>
        <a class="navbar-right btn btn-default" href="../ssst/sleepy_oop1.php" aria-label="Prev">
...
<div class="container sheet">
    <div class="row">
        <div class="col-md-2 text-left">
            <img height="200" src="../../img/stacked_skin_smooth_touch/sleepy_oop2.jpg">
        </div>
            ...
            <form action="javascript:void(0);" method="post">
                ...
                <table class="table table-bordered no-border-left no-border-right no-border-top">
                    <tr>
                        ...
                        <td colspan="5" class="text-center"><img src="../../img/stacked_skin_smooth_touch/sleepy_oop_4.jpg" height="150" alt="Piece 4"/></td>
