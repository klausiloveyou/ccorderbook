...
$designer = "Victoria B&auml;hr";
$stylename = "Tomorrow&apos;s Boss";
?>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item active" href="../ub/tomorrows_boss.php">Tomorrow&apos;s Boss</a>
...
<div class="container sheet">
    <div class="row">
        <div class="col-md-2 text-left">
            <img height="200" src="../../img/unusual_business/tomorrows_boss.jpg">
        </div>
            ...
            <form action="javascript:void(0);" method="post">
                ...
                <table class="table table-bordered no-border-left no-border-right">
                    <tr>
                        ...
                        <td colspan="5" class="text-center"><img src="../../img/unusual_business/tomorrows_boss_1.jpg" height="150" alt="Piece 1"/></td>
                        <td colspan="5" class="text-center"><img src="../../img/unusual_business/tomorrows_boss_2.jpg" height="150" alt="Piece 2"/></td>
                        <td colspan="5" class="text-center"><img src="../../img/unusual_business/tomorrows_boss_3.jpg" height="150" alt="Piece 3"/></td>
                    </tr>
                    <tr>
