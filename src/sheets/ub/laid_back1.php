...
<div class="container">
    <nav class="navbar navbar-expand navbar-light bg-faded">
        ...
        <a class="navbar-right btn btn-default" href="../ub/laid_back2.php" aria-label="Next">
            ...
            <form action="javascript:void(0);" method="post">
                ...
                <table class="table table-bordered no-border-left no-border-right">
                    <tr>
                        ...
                        <td colspan="5" class="text-center"><img src="../../img/unusual_business/laid_back_1.jpg" height="150" alt="Piece 1"/></td>
                        <td colspan="5" class="text-center"><img src="../../img/unusual_business/laid_back_2.jpg" height="150" alt="Piece 2"/></td>
                        <td colspan="5" class="text-center"><img src="../../img/unusual_business/laid_back_3.jpg" height="150" alt="Piece 3"/></td>
                    </tr>
                    <tr>
