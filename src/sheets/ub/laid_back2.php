...
$designer = "Anna Barria Kr&uuml;ger";
$stylename = "Laid Back";
?>
...
<div class="container">
    <nav class="navbar navbar-expand navbar-light bg-faded">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item active" href="../ub/laid_back1.php">Laid Back</a>
                    </div>
                </li>
        ...
        <a class="navbar-right btn btn-default" href="../ub/laid_back1.php" aria-label="Prev">
...
<div class="container sheet">
    <div class="row">
        <div class="col-md-2 text-left">
            <img height="200" src="../../img/unusual_business/laid_back.jpg">
        </div>
            ...
            <form action="javascript:void(0);" method="post">
                ...
                <table class="table table-bordered no-border-left no-border-right no-border-top">
                    <tr>
                        ...
                        <td colspan="5" class="text-center"><img src="../../img/unusual_business/laid_back_4.jpg" height="150" alt="Piece 4"/></td>
