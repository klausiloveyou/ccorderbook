...
<div class="container">
    <nav class="navbar navbar-expand navbar-light bg-faded">
        ...
        <a class="navbar-right btn btn-default" href="../ub/untieded1.php" aria-label="Prev">
            ...
            <form action="javascript:void(0);" method="post">
                ...
                <table class="table table-bordered no-border-left no-border-right no-border-top">
                    <tr>
                        ...
                        <td colspan="5" class="text-center"><img src="../../img/unusual_business/untieded_4.jpg" height="150" alt="Piece 4"/></td>
